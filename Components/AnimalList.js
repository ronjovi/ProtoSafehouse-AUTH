...
export default function AnimalList({ navigation }) {
  const [animals, setAnimals] = useState([
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1604916287784-c324202b3205?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=627&q=80",
      breed: "Black Cat",
      age: "5 years",
      sex: "Female",
      weight: "70 lbs",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1615789591457-74a63395c990?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
      breed: "Munchkin Cat",
      age: "1 year",
      sex: "Male",
      weight: "5 lbs",
      ...
      notes:
        "Lucifer is deaf, are intolerant of light, and have reduced vision in low light conditions",
    },
    {
      name: "Chronos",
      time: "2022-08-19 04:00:18",
      image:
        "https://p4.wallpaperbetter.com/wallpaper/539/65/318/cat-kitten-hat-hd-wallpaper-preview.jpg",
      ...
      notes:
        "Chronos has a condition where raw spots appear on her body, use specialized shampoo (such as: KetoChlor Shampoo and Malaseb Shampoo) when washing her",
    },
    {
      name: "Bob",
      time: "2022-08-21 04:00:25",
      image:
        "https://images.petpress.net/wp-content/uploads/2019/11/F216CEB5-0F02-4894-8F61-FCD9D770C0E0.jpeg",
      breed: "Persian Cat",
    ...
    },
    {
      ...
      image:
        "https://i.pinimg.com/originals/5c/92/ac/5c92ac042e5be8fab5c30635d0c36595.jpg",
      breed: "Companion Cat",
      age: "1 year",
      sex: "Male",
      weight: "4.5 lbs",
      ...
      notes:
        "Because she has allergies from certain chemicals in dog food (such as Melamine, MSG, Food dyes, corn syrup) a symptom of this allergy would be new hot spots appearing on her body... to learn more contact your local veterinarian",
    },
    {
      name: "Chupacabra",
      time: "2022-08-24 04:00:38",
      image:
        "https://i.pinimg.com/originals/8a/9a/c1/8a9ac1aa67aaf56efa2929624adac4b0.jpg",
      breed: "Sphynx Cat",
    ...
    },
    {
      ...
      image:
        "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F47%2F2021%2F12%2F02%2Fbalinese-sitting-in-a-tree-718322914-2000.jpg",
      ...
      notes:
        "This cat has a condition commonly referred to as: Addisons disease which requires steroids for treatment, to learn more contact your local veterinarian",
    },
    {
      name: "Pablo",
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <Image
          source={require("../assets/Safehouse_logo.png")}
      ...
      <View style={styles.bar}>
        <TouchableOpacity
          style={styles.marketButtonContainer}
          onPress={goToMarket}
        >
          <Image
        ...
        <TouchableOpacity
          style={styles.shelterButtonContainer}
          onPress={goToShelter}
        >
          <Image
